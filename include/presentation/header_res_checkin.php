    	...
    	<div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class=""><a href="reserved.php">MyRewards</a></li>
              <li class=""><a href="reserved.php">Coupons</a></li>
              <li class=""><a href="/notify_from_customer.php">Notify Me When</a></li>
            </ul>
            
	        <ul class="nav pull-right">
	          <li class=""><a href="./">Back to Main</a></li>
	        </ul>
          </div>
